...
public static class WillEat_Minotaur
{
    ...
    [HarmonyPostfix]
    public static bool WillEat_NewTemp_Postfix(bool __result, Pawn p, ThingDef food, Pawn getter, bool careIfNotAcceptableForTitle, bool allowVenerated)    //Allows pawns with the Ruminant Stomach Gene to eat Hay
    {
    ...
    [HarmonyPostfix]
    public static float Ingested_Postfix(float __result, Pawn ingester, Thing __instance)  //Prevents pawns without the ruminant stomach gene from gaining nutrition from hay.
    {
